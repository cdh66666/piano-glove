...
| 项 | 状态 |
| --- | --- |
| 编译通过 | ✅ `pio run` 零错误（RAM 6.7% / Flash 22.1%） |
...
INFO                    # 应回 fw=PIANO_GLOVE_2 profile=STS3032 range=4095 ver=2.1.1
PING 1                  # 接上舵机后逐个数
...
```bash
python host/tests/bench_move.py COM3 --rate --rate-cycles 3 --rate-depth 60
```
